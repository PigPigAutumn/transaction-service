...
api[0].list.push({
    ...
    order: '1',
    link: 'controller_of_transaction_api',
    desc: 'Controller of transaction API',
    list: []
})
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'http://localhost:10100/transaction',
    desc: 'create transaction',
});
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'http://localhost:10100/transaction/{id}',
...
api[0].list[0].list.push({
    order: '4',
    deprecated: 'false',
    url: 'http://localhost:10100/transaction/list',
